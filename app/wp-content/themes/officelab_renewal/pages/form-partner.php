<?php
	...
	$breadcrumb = '<li>お問い合わせ</li><li>協力パートナー応募</li>';
	get_header();
?>
	...
	<section class="l-contact inner -m">
		<div class="contact__tab">
			<ul>
				...
				<li class="-isActive"><span>協力パートナー応募</span></li>
				<li>
					<a href="<?php home_url() ?>/contact/entry/">採用エントリー</a>
				</li>
			</ul>
		</div>
		<div class="contact__panel -partner">
			<h2 class="contact__panel_title">協力パートナー応募</h2>
